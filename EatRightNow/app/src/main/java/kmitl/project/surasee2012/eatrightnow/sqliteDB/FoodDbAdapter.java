package kmitl.project.surasee2012.eatrightnow.sqliteDB;
...
public class FoodDbAdapter {
    ...
    private double getBestCal() {
        ...
        switch (userProfile.getGender()) {
            case "ชาย":
                bmr = 66 + (13.7 * userProfile.getWeight()) + (5 * userProfile.getHeight())
                ...
                break;
            case "หญิง" :
                bmr = 665 + (9.6 * userProfile.getWeight()) + (1.8 * userProfile.getHeight())
